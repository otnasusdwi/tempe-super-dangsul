                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Tipe</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="javascript:">Data Tipe</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-xl-2 col-md-2">
                                                <a href="{{ route('admin.create_tipe') }}" class="btn theme-bg" style="color: white; width: 100%;">Tambah</a>
                                            </div>
                                        </div>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
																...
																<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																	<a class="dropdown-item" href="{{ route('admin.edit_tipe', $row->id_tipe) }}">Edit</a>
																	<a class="dropdown-item" href="#" onclick="del('{{ url('admin/delete_tipe', $row->id_tipe) }}')">Hapus</a>
																</div>
                                                            </div>
                                                        </td>
                                                    </tr>
