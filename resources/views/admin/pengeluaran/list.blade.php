                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Data Pengeluaran</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-xl-2 col-md-2">
                                                <a href="{{ route('admin.create_pengeluaran') }}" class="btn theme-bg" style="color: white; width: 100%;">Tambah</a>
                                            </div>
                                        </div>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <a class="dropdown-item" href="{{ route('admin.edit_pengeluaran', $row->id) }}">Edit</a>
                                                                    <a class="dropdown-item" href="#" onclick="del('{{ url('admin/delete_pengeluaran', $row->id) }}')">Hapus</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
