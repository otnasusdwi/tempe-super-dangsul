                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:">Data Harga</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-xl-2 col-md-2">
                                                    <a href="{{ route('admin.create_harga') }}" class="btn theme-bg"
                                                ...
                                                <table class="table table-hover text-center" id="table_id">
                                                    <thead>
                                                        <tr class="unread">
                                                            ...
                                                            <th>
                                                                <h6 class="mb-1"><b>Tipe Sales</b></h6>
                                                            </th>
                                                            <th>
                                                                <h6 class="mb-1"><b>Harga</b></h6>
                                                            </th>
                                                            <th>
                                                                <h6 class="mb-1"><b>Harga Kulakan</b></h6>
                                                            </th>
                                                            <th>
                                                                <h6 class="mb-1"><b>Berat</b></h6>
                                                            </th>
                                                            <th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($data as $index => $row)
                                                            <tr class="unread">
                                                                ...
                                                                <td>
                                                                    <h6 class="mb-1">{{ $row->harga }}</h6>
                                                                </td>
                                                                <td>
                                                                    <h6 class="mb-1">{{ $row->harga_kulakan }}</h6>
                                                                </td>
                                                                <td>
                                                                    <h6 class="mb-1">{{ $row->berat }}</h6>
                                                                </td>
                                                                <td>
                                                                    <div class="dropdown">
                                                                        <button
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('admin.edit_harga', $row->id_harga) }}">Edit</a>
                                                                            <a class="dropdown-item" href="#"
                                                                                onclick="del('{{ url('admin/delete_harga', $row->id_harga) }}')">Hapus</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
