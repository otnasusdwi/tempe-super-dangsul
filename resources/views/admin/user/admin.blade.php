                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Data Admin</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-xl-2 col-md-2">
                                                <a href="{{ route('admin.create_admin') }}" class="btn theme-bg"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="unread">
                                                        ...
                                                        <td>
                                                            ...
                                                            href="{{ route('admin.edit_admin', $row->id) }}">Edit</a>
                                                            <a class="dropdown-item"
                                                            href="{{ route('admin.reset_password', $row->id) }}">Reset Password</a>
                                                            @if ( Auth::user()->level == 2 || Auth::user()->level == 3 )
                                                            <a class="dropdown-item" href="#"
                                                            onclick="del('{{ url('admin/delete_user', $row->id) }}')">Hapus</a>
                                                            @endif
