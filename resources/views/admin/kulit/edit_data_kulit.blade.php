						...
						<div class="row align-items-center">
							<div class="col-md-12">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="javascript:">Update Data Kulit</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="page-wrapper">
						...
						<div class="row">
							...
							<div class="col-xl-12 col-md-12">
								<form method="POST" action="{{ route('admin.update_data_kulit') }}">
									@csrf
														...
														<tr>
															...
															<td>
																<h6 class="mb-1">
																	...
																	<input type="number" class="form-control" placeholder="Sak" name="kulit[]" min="0" required value="{{$row->kulit}}">
																</h6>
															</td>
															<td>
																<h6 class="mb-1">
